...
<html lang="nl">
    ...
    <head>
        ...
        <title>Avatar Customers Dashboard</title>
                                        ...
                                        <div class="header-right-info">
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                <li class="nav-item dropdown">
                                                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa fa-comment" aria-hidden="true"></i><span class="indicator-ms"></span></a>
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="img/profielfotos/gc.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                                        <span class="message-date">1 juni 2020</span>
                                                                        <h3>Giancarlo</h3>
                                                                        <p>Hi, Anouk gaat hiermee aan de slag!</p>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#">
                                                                    <div class="message-img">
                                                                        <img src="img/profielfotos/raies.jpg" alt="">
                                                                    </div>
                                                                    <div class="message-content">
                                                            ...
                                                            <li>
                                                                <a href="#">
                                                                    ...
                                                                    <div class="notification-content">
                                                                        <span class="notification-date">1 juni 2020</span>
                                                                        <h2>Anouk Martens</h2>
                                                                        <p>Klantbereik toegevoegd aan agenda</p>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a href="#">
                                                                    ...
                                                                    <div class="notification-content">
                                                                        <span class="notification-date">25 mei 2020</span>
                                                                        <h2>Raies Bengattou</h2>
                                                                        <p>Instagram feed toegevoegd aan bestanden.</p>
                                                                    </div>
                                                                </a>
                                                            </li>
                                                        </ul>
                                                        <div class="notification-view">
                                                            <a href="#">Bekijk alle meldingen</a>
                                                        </div>
                                                    </div>
                                                </li>
                                                <li class="nav-item">
